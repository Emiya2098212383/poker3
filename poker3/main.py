...
if game_type == 3:
    ...
    record_deck(player_a, '三人斗地主01.txt')
    record_deck(player_b, '三人斗地主02.txt')
    record_deck(player_c, '三人斗地主03.txt')
    record_deck(player_dumy, '三人斗地主留牌.txt')

if game_type == 4:
    deal_to_multi_players_remain(
        new_deck, 8, player_dumy, player_a, player_b, player_c, player_d)
    record_deck(player_a, '四人斗地主01.txt')
    record_deck(player_b, '四人斗地主02.txt')
    record_deck(player_c, '四人斗地主03.txt')
    record_deck(player_d, '四人斗地主04.txt')
    record_deck(player_dumy, '四人斗地主留牌.txt')
